            ...
            <div className="my-12 flex flex-col md:flex-row gap-10">
                ...
                <div className="md:w-1/2 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start">
                    ...
                    <div className="space-y-4 mt-5">
                        ...
                        <ul className="space-y-3">
                            <p href="/" className="hover:text-gray-300">(012) 1234-567-890</p>
                            <p href="/" className="hover:text-gray-300">123 xyz xyz</p>
                            <p href="/" className="hover:text-gray-300">qwuerybaihefv, qiwu - hrebcl</p>
                            <p href="/" className="hover:text-gray-300">095467</p>
                        </ul>
                    </div>
                </div>
            </div>
