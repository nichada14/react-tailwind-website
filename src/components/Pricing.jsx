...
const Pricing = () => {
    ...
    const packages = [
        {name: "Start", monthlyPrice: 19, yearlyPrice: 199, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.", green: "/src/assets/Rectangle-green.png"},
        {name: "Advance", monthlyPrice: 39, yearlyPrice: 399, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.", green: "/src/assets/Rectangle-green.png"},
        {name: "Premium", monthlyPrice: 59, yearlyPrice: 599, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.", green: "/src/assets/Rectangle-green.png"}
    ]
    ...
    return (
        <div className="md:px-14 p-4 max-w-s mx-auto py-10" id='pricing'>
            <div className="text-center">
                ...
                <p className="text-tartiary md:w1/3 mx-auto px-4">
            ...
            <motion.div 
                ...
                className="grid sm:grid-cols-3 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto"
            >
                {
